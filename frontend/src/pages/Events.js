...
class EventsPage extends Component{
    ...
    render(){
        ...
        const eventList = this.state.events.map(event => {
            return  (<li key={event.id} className="events_list_item">{event.title}</li>);
        });
        ...
        return (
            <React.Fragment>
                ...
                {this.state.creating && (
                    <Modal title="Add title" canConfirm canCancel onConfirm = {this.modalConfirmHandler} onCancel = {this.modalCancelHandler}>
                        <form>
